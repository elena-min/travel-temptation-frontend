...
function getReviewsByUser(userId){
    return axios.get(`http://localhost:8080/users/${userId}/reviews`)
        .then(response => response.data);   
}
function getBookingsByUser(userId){
    return axios.get(`http://localhost:8080/users/${userId}/bookings`)
        .then(response => response.data);   
}
function getPastBookingsByUser(userId){
    return axios.get(`http://localhost:8080/users/${userId}/past-bookings`)
        .then(response => response.data);   
}
function getFutureBookingsByUser(userId){
    return axios.get(`http://localhost:8080/users/${userId}/future-bookings`)
        .then(response => response.data);   
}
